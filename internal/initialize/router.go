...
import (
	...
	c "github.com/ngductoann/go_backend_architecture/internal/controller"
...
func InitRouter() *gin.Engine {
	...
	v1 := r.Group(("/v1/2025"))
	{
		...
		v1.GET("/user/1", c.NewUserController().GetUserByID) // Register the route for GET requests to "/v1/2025/ping"
